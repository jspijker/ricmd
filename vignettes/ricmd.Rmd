...
```
#> Error in ri_test_check_docker(): could not find function "ri_test_check_docker"
#> Error in ri_test_get_catalog_provider_ip(): could not find function "ri_test_get_catalog_provider_ip"
#> Error in ri_test_auth_file_exists(): could not find function "ri_test_auth_file_exists"
#> Error in ri_test_create_demo_env(irods_ip): could not find function "ri_test_create_demo_env"
#> Error in import("irods.session"): could not find function "import"
#> Error in eval(expr, envir, enclos): object 'irods' not found
#> Error in is_valid_session(session): could not find function "is_valid_session"
#> Error in eval(expr, envir, enclos): object 'session' not found
#> Error in eval(expr, envir, enclos): object 'session' not found
#> Warning in rm(session): object 'session' not found
```
...
``` r
library(ricmd)
#> Error in library(ricmd): there is no package called 'ricmd'
```

``` r
ri_session()
#> Error in ri_session(): could not find function "ri_session"
```
...
#> Error in eval(expr, envir, enclos): object 'irods_zone' not found
```

``` r
ri_setCollection(my_collection)
#> Error in ri_setCollection(my_collection): could not find function "ri_setCollection"
```
...
``` r
ri_getCollection()
#> Error in ri_getCollection(): could not find function "ri_getCollection"
```
...
#> Error in eval(expr, envir, enclos): object 'my_collection' not found
```

``` r
ri_createCollection(test_collection)
#> Error in ri_createCollection(test_collection): could not find function "ri_createCollection"
```
...
#> Error in ri_listSubCollections(): could not find function "ri_listSubCollections"
```
...
#> Error in ri_setDatadir(testDatadir): could not find function "ri_setDatadir"
```
...
#> Error in ri_setCollection(test_collection): could not find function "ri_setCollection"
```

``` r
ri_put(filename = file.path(testDatadir, "datafile.rds"))
#> Error in ri_put(filename = file.path(testDatadir, "datafile.rds")): could not find function "ri_put"
```
...
``` r
ri_listDataObjects()
#> Error in ri_listDataObjects(): could not find function "ri_listDataObjects"
```
...
#>   could not find function "ri_put"
```
...
#> Error in ri_put(filename = file.path(testDatadir, "datafile.rds"), overwrite = TRUE): could not find function "ri_put"
```
...
``` r
ri_get("datafile.rds")
#> Error in ri_get("datafile.rds"): could not find function "ri_get"
```
...
#> '/tmp/RtmpyT5cIm/data/datafile.rds', probable reason 'No such file or
#> directory'
...
#> Error in ri_get("datafile.rds", overwrite = TRUE): could not find function "ri_get"
```
...
#> Error in ri_get("datafile.rds", filename = "datafile2.rds"): could not find function "ri_get"
```
...
#> Error in ri_metaAdd(object = "datafile.rds", attribute = "attr1", value = "val1"): could not find function "ri_metaAdd"
```
...
#> Error in ri_metaAdd(object = "datafile.rds", attribute = "attr2", value = "val2"): could not find function "ri_metaAdd"
```

``` r
ri_metaAdd(object = "datafile.rds", attribute = "attr3", value = "val3", units = "unit1")
#> Error in ri_metaAdd(object = "datafile.rds", attribute = "attr3", value = "val3", : could not find function "ri_metaAdd"
```
...
#> Error in ri_metaGet("datafile.rds"): could not find function "ri_metaGet"
```
...
#> Error in ri_metaRemove("datafile.rds", attribute = "attr3", value = "val3", : could not find function "ri_metaRemove"
```
...
```
#> iRODSAccount.__init__() missing 4 required positional arguments: 'irods_host',
#> 'irods_port', 'irods_user_name', and 'irods_zone_name'
#> Error in eval(expr, envir, enclos): object 'session' not found
#> Warning in rm(session): object 'session' not found
```
